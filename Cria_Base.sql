...
INSERT INTO trabalho_concessionaria.veiculo (id, quantidade, ano, modelo, cor, aquisicao, venda, patio, tipo) VALUES
	...
	(3, 48, 2016, 'Eduarda Dias', 'Branco', 3, 25, 2, 'Carro'),
	(4, 15, 2015, 'Bernardo das Neves', 'Cinza', 5, 30, 1, 'Carro'),
	(5, 37, 2013, 'Arthur da Costa', 'Preto', 5, 30, 2, 'Moto'),
	(6, 52, 2018, 'João Vitor das Neves', 'Preto', 4, 30, 2, 'Moto'),
	(7, 66, 2010, 'Arthur da Cruz', 'Branco', 3, 30, 2, 'Carro'),
	(8, 16, 2015, 'Emanuel Barbosa', 'Cinza', 3, 25, 1, 'Carro'),
	(9, 42, 2015, 'Gabriel Correia', 'Preto', 1, 24, 2, 'Moto'),
	(10, 41, 2013, 'Maria Clara Cavalcanti', 'Vermelho', 4, 24, 2, 'Carro'),
	(11, 83, 2010, 'Isabelly Nogueira', 'Branco', 5, 30, 1, 'Moto'),
	(12, 37, 2015, 'João Guilherme Rodrigues', 'Azul', 3, 24, 2, 'Carro'),
	(13, 9, 2018, 'Juliana Gonçalves', 'Cinza', 5, 25, 2, 'Moto'),
	(14, 68, 2015, 'Brenda da Luz', 'Azul', 2, 25, 1, 'Carro'),
	(15, 93, 2018, 'Alexia Lopes', 'Branco', 4, 25, 1, 'Carro'),
	(16, 53, 2010, 'Eloah da Conceição', 'Cinza', 2, 25, 1, 'Carro'),
	(17, 21, 2013, 'Raul Mendes', 'Preto', 5, 25, 1, 'Moto'),
	(18, 16, 2018, 'Lívia das Neves', 'Vermelho', 5, 30, 1, 'Carro'),
	(19, 55, 2015, 'Yasmin Santos', 'Branco', 1, 30, 2, 'Moto'),
	(20, 68, 2013, 'Igor Lima', 'Preto', 4, 24, 2, 'Moto');
